            ...
            success: function(data) {
                ...
                adminArticleData.forEach(article => {
                    ...
                    adminArticles.row.add([
                        ...
                        <a href='#' class='link-danger' data-bs-toggle='modal' data-bs-target='#deleteArticleModal' onclick='prepareDelete(${article.article_id})'><i class='fa-solid fa-trash fs-5 mx-2'></i></a>y
