...
<body>
    ...
    <main class="bg-light account-mgmt">
        <div class="px-3 py-3">
            ...
            <div class="col-12 col-md-6">
                <div class="d-flex flex-wrap justify-content-md-end gap-2">
                    <!-- New Category Button -->
                    <button id="newAccountBtn" class="btn btn-primary px-3 py-2 rounded fw-semibold" data-bs-toggle="modal" data-bs-target="#categoryModal">
        ...
        <table id="categoryTable" class="table table-hover nowrap" style="width:100%">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Category Name</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <form id="categoryForm">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="categoryName" name="categoryName" class="form-control" required placeholder="Enter category name">
            </div>
            </div>
