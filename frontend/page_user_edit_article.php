...
$stmt = $conn->prepare("SELECT * FROM articles WHERE article_id = ? AND user_id = ?");
...
<style>
    #editUserArticleForm label.error {
        font-size: 0.8rem;
        font-weight: 600;
        color: #FB667A;
    }
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10">
                        <form id="editUserArticleForm" autocomplete="off">
                            ...
                            <div class="row align-stretch">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="user_edit_title" id="title" class="form-control" 
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select id="category" name="user_edit_category" class="form-select">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="user_edit_source_url" id="source_url" class="form-control" 
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control" id="date_published" name="user_edit_date_published"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="content" name="user_edit_content" 
                            ...
                            <hr class="my-4">
                            <button id="usrEditArticleBtn" type="submit" class="btn btn-primary w-100 mt-3 primaryBtnAnimate">Save Article</button>
    ...
    $(document).ready(function () {
        ...
        rules: {
           ...
           user_edit_category: {
            ...
            user_edit_source_url: {
                required: true
            },
            user_edit_date_published: {
                required: true,
            },
            user_edit_content: {
                required: true,
        ...
        messages: {
            user_edit_title: "Please enter your title.",
            user_edit_category: "Please Select a Category.",
            user_edit_source_url: "Please enter your source URL.",
            user_edit_date_published: "Please enter your published date.",
            user_edit_content: "Please put your article content.",
        },
        submitHandler: function (form, e) {
            ...
            $.ajax({
                url: '../backend/phpscripts/user_edit_article.php',
                type: 'POST',
                ...
                success: function (response) {
                    ...
                    if (res.success) {
                        ...
                        window.location.href = 'page_user_article_management.php';
                    } else {
